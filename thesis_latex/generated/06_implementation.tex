\chapter{Implementation of the Multimodal Fake News Detection Framework}
...
\section{6.2 Development Environment}
...
\section{6.3 Dataset Preparation and Label Standardization}
...
\section{6.4 Image Branch Implementation}
...
\section{6.5 Text Branch Implementation}
...
\section{6.6 Reliability Feature Extraction}
...
\section{6.7 Reinforcement Learning Fusion Implementation}
...
\section{6.8 Supervised and Deterministic Baseline Implementation}
...
\section{6.9 Explainability Implementation}
...
\section{6.10 Testing and Reproducibility}
...
The six notebooks in the \texttt{notebooks} folder provide a reproducible demonstration workflow. They cover data preparation, image model training, text model training, baselines and reliability, RL adaptive fusion, and explainability with final results.
...
\caption{Implementation-to-evaluation evidence flow used to connect saved artifacts with final thesis claims.}
\label{fig:implementation_evidence_flow}
\end{figure}
