\chapter{Developments and Challenges in Multimodal Fake News Detection}
...
\section{2.2 Fake News Detection in Social Media}
...
\section{2.3 Text-Based Fake News Detection}
...
\section{2.4 Image-Based and Multimodal Fake News Detection}
...
\section{2.5 Fusion Strategies in Multimodal Learning}
...
\section{2.6 Explainability in Fake News Detection}
...
\section{2.7 Comparative Analysis of Existing Methods}


Table 2.1 summarizes key categories of related work and their relevance to this research.


\textbf{Table 2.1: Comparative analysis of related fake news detection methods}
